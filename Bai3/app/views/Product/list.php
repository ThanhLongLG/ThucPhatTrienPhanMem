            ...
            <div class="col">
                <div class="card h-100 shadow-sm">
                    ...
                    $imagePath = $product->image 
                        ? '/TranThanhLong/public/uploads/products/' . htmlspecialchars($product->image, ENT_QUOTES, 'UTF-8') 
                        : '/TranThanhLong/public/uploads/default-product.jfif';
                    ?>
                    <img src="<?php echo $imagePath; ?>" 
                         class="card-img-top product-image" 
                         alt="<?php echo htmlspecialchars($product->name, ENT_QUOTES, 'UTF-8'); ?>"
                         onerror="this.src='/TranThanhLong/public/uploads/default-product.jfif';">
